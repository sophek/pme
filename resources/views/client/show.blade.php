                    ...
                    <div class="col-lg-4">
                            ...
                            <div class="table-box opport-box">
                                ...
                                <div class="table-detail">
                                    <div class="member-info">
                                        <p class="text-dark m-b-5"><b>Visit Date: </b> <span class="text-muted">{{$relative->dob}}</span></p>
                                    </div>
                                </div>
                        ...
                        <div class="card-box m-b-10">
                            <div class="table-box opport-box">
                                ...
                                <div class="table-detail">
                                    <a href="#" class="btn btn-sm btn-primary waves-effect waves-light">Convert to Client</a>
                                </div>
